...
export default function CoverAvatar() {
  ...
  return (
    <div className="relative mx-auto w-28 h-28 md:w-32 md:h-32">
      ...
      {/* UploadThing v7 clickable camera button (NO children prop) */}
      <div className="absolute -bottom-2 -right-2">
        <UploadButton<OurFileRouter, "coverUploader">
          ...
          appearance={{
            container: "w-8 h-8",
            button:
              "w-8 h-8 rounded-full bg-black text-white flex items-center justify-center shadow hover:bg-black/90 disabled:opacity-60 disabled:cursor-not-allowed",
          }}
          content={{
